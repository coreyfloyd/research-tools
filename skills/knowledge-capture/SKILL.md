...
3. Reconcile those items with the conversation's decisions and existing knowledge. Present one approval table. Every wiki recommendation is a complete action: capture required provenance **and run `research-to-wiki`**. Never stop at raw staging.
